...
from src_prediction.embedding_strategy import SpectralEmbeddingStrategy
...
from src_prediction.kinase_categories import assign_kinase_categories, compute_psp_substrate_counts
...
def main() -> None:
    experiment_name = "liver_multi_kinase_spectral"
    ...
    # Liver FC: base relations + fold-change correlation edges.
    # PSP 'phosphorylates' edges excluded from embedding inside run_leave_one_out.
    allowed_relations = set(GENERIC_BASE_RELATIONS) | SITE_CORR_FC_RELATIONS

    print("=== Running leave-one-out: liver FC, spectral embedding + categories ===")
