...
from src_prediction.relation_filters import GENERIC_BASE_RELATIONS, SITE_CORR_RELATIONS


def main() -> None:
    experiment_name = "liver_multi_kinase"
    ...
    allowed_relations = set(GENERIC_BASE_RELATIONS) | SITE_CORR_RELATIONS

    print("=== Running leave-one-out on multi-kinase sites: liver model ===")
