...
def main() -> None:
    experiment_name = "cancer_multi_kinase_spectral"
    ...
    # Cancer: base relations + tumor-sample raw abundance correlation edges.
    allowed_relations = set(GENERIC_BASE_RELATIONS) | SITE_CORR_CANCER_RELATIONS

    print("=== Running leave-one-out: cancer, spectral embedding + categories ===")
