...
def main() -> None:
    ...
    comparison_out = PRED_OUTPUTS_DIR / "comparison_multi_kinase_generic_vs_liver.csv.gz"
    changed_top1_out = PRED_OUTPUTS_DIR / "comparison_multi_kinase_changed_top1.csv.gz"
    improved_out = PRED_OUTPUTS_DIR / "comparison_multi_kinase_improved_in_liver.csv.gz"
    summary_out = PRED_OUTPUTS_DIR / "comparison_multi_kinase_summary.txt"
    ...
    summary_lines = [
        "Comparison: generic model vs liver model — full multi-kinase LOO (80% fold-change site correlation)",
        "=" * 100,
