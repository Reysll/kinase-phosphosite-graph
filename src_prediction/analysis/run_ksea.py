...
from src_prediction.core.config import GENERIC_EDGES, PRED_OUTPUTS_DIR
from src_prediction.core.io_utils import read_csv_auto, write_text
from src_prediction.analysis.ksea import compute_ksea_scores, load_site_fc_values
...
def _build_report(
    ...
    lines = [
        ...
        "  score_k = (s_bar - p_bar) * sqrt(m) / delta",
        ...
        "  sqrt(m) is in the numerator: more substrates increase confidence",
        "  in the enrichment estimate, rewarding (not penalizing) coverage.",
