...
def main() -> None:
    experiment_name = "generic_multi_kinase_spectral"
    ...
    # Generic: base relations only, no correlation edges.
    allowed_relations = set(GENERIC_BASE_RELATIONS)

    print("=== Running leave-one-out: generic, spectral embedding + categories ===")
