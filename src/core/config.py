...
# Project root = two folders above /src/core (reorganized 2026-06-25; was one folder
# above /src before the src/core/ split — update this if config.py ever moves again).
