...
PPI_FILE = os.path.join(DATA_DIR, "high_confidence_score.csv")
GENE_PROTEIN_MAP = os.path.join(DATA_DIR, "gene_protein.csv")
PTMCODE_FILE = os.path.join(DATA_DIR, "PTMcode2_associations_between_proteins.txt")
